...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2023 at 09:54 AM
...
INSERT INTO `books` (`id`, `title`, `slug`, `description`, `author`, `publisher`, `cover`, `price`, `views`, `stock`, `status`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`, `weight`) VALUES
(1, 'Sangkuriang', 'sangkuriang', 'Legenda Indonesia', 'Abdi', 'Maya', 'book-covers/ZjP6APIksk41kqnQqLkotjZsiIOeLI91ty4APFzd.jpg', 23000.00, 0, 8, 'PUBLISH', 2, 2, NULL, '2023-05-08 00:12:51', '2023-05-08 01:23:27', NULL, 0.00),
(2, 'Belajar Laravel 8', 'belajar-laravel-8', 'Framework PHP favorit', 'Mahmud', 'Abdul', 'book-covers/iR7eSFhzUzl6IP4SaiFekCwLfwzqnzupLacM7F1d.jpg', 50000.00, 0, 5, 'PUBLISH', 2, 2, NULL, '2023-05-08 00:57:50', '2023-05-08 01:16:26', NULL, 0.00);
...
(1, 1, 2, 1, '2023-05-08 02:46:31', '2023-05-08 09:17:47'),
(2, 2, 1, 1, '2023-05-08 08:02:40', '2023-05-08 09:21:22');
...
INSERT INTO `categories` (`id`, `name`, `slug`, `image`, `created_by`, `updated_by`, `deleted_by`, `deleted_at`, `created_at`, `updated_at`, `status`) VALUES
(1, 'Fiksi', 'fiksi', 'category_images/n51TRd7WjlUC5DYEtHhy0G9he2SfSan8ZXL5IYgG.jpg', 2, 2, NULL, NULL, '2023-04-10 18:40:38', '2023-05-08 00:42:11', 'PUBLISH | DRAFT'),
(2, 'Alam', 'alam', 'category_images/o68liYbojfi6vemvEi4XsxXt0EYmjUmEJL4G6895.jpg', 2, 2, NULL, NULL, '2023-04-13 22:32:53', '2023-05-08 00:41:48', 'PUBLISH | DRAFT'),
(3, 'Pelajaran', 'pelajaran', 'category_images/XxWuIpI4E5JgSBkDe9LIZhkjqY7RxrRl7Eg1zzZD.jpg', 2, 2, NULL, NULL, '2023-05-01 18:03:37', '2023-05-08 00:59:31', 'PUBLISH | DRAFT');
...
(4, '2023_03_21_005757_penyesuaian_table_users', 2),
(5, '2023_04_11_003320_create_categories_table', 3),
(6, '2023_04_17_050607_create_books_table', 4),
(7, '2023_04_17_050952_create_book_category_table', 5),
(8, '2023_05_01_165148_create_orders_table', 6),
(9, '2023_05_01_165358_create_book_order_table', 7),
(10, '2023_05_02_024039_create_orders_table', 8),
(11, '2023_05_02_024208_create_book_order_table', 9),
(12, '2023_05_02_030850_create_orders_table', 10),
(13, '2023_05_02_030955_create_book_order_table', 11),
(14, '2023_05_02_033637_create_books_table', 12),
(15, '2023_05_02_033832_create_book_category_table', 13),
(16, '2023_05_08_080749_create_books_table', 14),
(17, '2023_05_08_080917_create_book_category_table', 15),
(18, '2023_06_06_024354_create_provinces_table', 16),
(19, '2023_06_06_024520_create_cities_table', 16),
(20, '2023_06_20_011049_adds_api_token_to_users_table', 17);
...
CREATE TABLE `orders` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `courier_service` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `user_id`, `total_price`, `invoice_number`, `status`, `created_at`, `updated_at`, `courier_service`) VALUES
(1, 8, 40000.00, '100', 'PROCESS', '2023-05-08 02:46:31', '2023-05-07 23:10:30', ''),
(2, 3, 20000.00, '101', 'PROCESS', '2023-05-08 07:11:11', '2023-05-08 01:09:52', '');
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `username`, `roles`, `address`, `phone`, `avatar`, `status`, `city_id`, `province_id`, `api_token`) VALUES
(2, 'Site Administrator', 'administrator@larashop.test', NULL, '$2y$10$7WMcZNapWhDwmFzNGSWSy.v99Pf2034f5tlM0aRCKWgydMg.WmsUu', 'FwFtD15NOJh3Zf0TCU7Vq8s2ERwzNaFyiUMU1YsBM17f7MMlHDzWXsWKNjjz', '2023-04-03 18:17:02', '2023-06-26 17:41:43', 'administrator', '[\"ADMIN\"]', 'Sarmili, Bintaro, Tangerang Selatan', NULL, 'avatars/S6e1xgoLbdcaw2BaAI4bINL4uyZ1nCtTWMB6oGLD.jpg', 'ACTIVE', 0, 0, 'Ejseh0m1QqEmTtFFRNVmeSpnIxv6tYW0sgjNiGIU2lrpbmIOyndeptkxLte6'),
(3, 'Rima Safitri', 'rimasafitri6844@gmail.com', NULL, '$2y$10$VRadbDwUT72/.P5PvIudH.6ivTLu2dvEfWQMHhc4RD1vDaiJEHAi6', NULL, '2023-04-03 18:47:38', '2023-05-01 18:15:21', 'rimasafitri_96', '[\"CUSTOMER\"]', 'Barito Kuala No 32 RT 04', '083150115055', 'avatars/KFWuwxFvB0TKa07v2uzavR4dlCGSFGneTAUb3EG0.png', 'ACTIVE', 0, 0, NULL),
(7, 'Meerqeen', 'mee@gmail.com', NULL, '$2y$10$X8eYJ5yNlv44jRrI3Caf2eqAktA6eZ3PODc1alVj/fzHCzKG9uG3S', NULL, '2023-04-03 19:00:55', '2023-05-08 00:36:26', 'mee', '[\"CUSTOMER\"]', 'Malaysia', '082112121313', 'avatars/jfhsF8zozRzZGVZRcrp6sxcacp8wRacot9qMd1jb.jpg', 'ACTIVE', 0, 0, NULL),
(8, 'Anna J', 'anna@gmail.com', NULL, '$2y$10$52MIWMXNA2bBH87cck8dneUVTScxU08MZtn1yVah/z1XDef8lkbMG', NULL, '2023-05-01 18:32:55', '2023-05-08 00:37:11', 'anna', '[\"CUSTOMER\"]', 'Selangor', '082112121313', 'avatars/NQk4opgjrmrysTmME13sKklH3wHrzygo2qJlXlYY.jpg', 'ACTIVE', 0, 0, NULL);
